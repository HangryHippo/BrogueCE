...
itemTable armorTable[NUMBER_ARMOR_KINDS] = {
    ...
    {"cloak",               "", "", 10, 350,        12, 0, {40,40,0},      true, false, 0, false, "A sheet of thickly woven fabric hides the wearer from the eyes of others."},
    {"thorned mail",        "", "", 10, 500,        13, 0, {50,50,0},      true, false, 0, false, "Sharp metal spikes protrude from a splint mail base, harming any who dare attack its wearer."},
    ...
    {"mirror mail",         "", "", 10, 1000,       17, 0, {90,90,0},      true, false, 0, false, "Metal plates of such polish adorn this suit that one can almost make out a reflection of oneself."},
    {"shining armor",       "", "", 10, 1300,       19, 0, {110,110,0},    true, false, 0, false, "Antimagic material coating a plate mail base offers unsurpassed protection."}
};
